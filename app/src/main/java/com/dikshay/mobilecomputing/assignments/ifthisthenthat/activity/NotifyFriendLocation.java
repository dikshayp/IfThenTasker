...
public class NotifyFriendLocation extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private MarkerOptions marker;
    private LatLng markerLocation;
    private Location notifyFriendLocation;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.d("Inside Maps onCreate", "onCreate");
        setContentView(R.layout.activity_notify_friend_location);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        toggleRecepie.setChecked(GpsData.isNotifyFriend());

        // Add a marker to previous map location
        notifyFriendLocation = GpsData.getNotifyFriendLocation();
        if(notifyFriendLocation != null){
            markerLocation = new LatLng(notifyFriendLocation.getLatitude(), notifyFriendLocation.getLongitude());
        }
        else{
        ...
        setLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText mobileNumber = (EditText) findViewById(R.id.set_mobile_number);
                if(mobileNumber.getText().toString() != null && mobileNumber.getText().toString() != ""){
                    Toast.makeText(getApplicationContext(), "Mobile ", Toast.LENGTH_LONG).show();
                    GpsData.setMobileNumber(mobileNumber.getText().toString());
                }
                else{
                ...
                //Set Class Location
                notifyFriendLocation = new Location("Home");
                notifyFriendLocation.setLatitude(markerLocation.latitude);
                notifyFriendLocation.setLongitude(markerLocation.longitude);
                GpsData.setNotifyFriendLocation(notifyFriendLocation);
