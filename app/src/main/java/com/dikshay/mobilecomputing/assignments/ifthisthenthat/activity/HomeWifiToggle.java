...
public class HomeWifiToggle extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_wifi_toggle);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        toggleRecepie.setChecked(GpsData.isWifiToggle());

        // Add a marker to previous map location
        homeLocation = GpsData.getHomeLocation();
        if(homeLocation != null){
            markerLocation = new LatLng(homeLocation.getLatitude(), homeLocation.getLongitude());
        }
        else{
            markerLocation = new LatLng(Constants.DEFAULT_LATITUDE, Constants.DEFAULT_LONGITUDE);
        }
        marker = new MarkerOptions().position(markerLocation).title("Marker in Home/Default").draggable(true);
        ...
        setLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                homeLocation.setLatitude(markerLocation.latitude);
                homeLocation.setLongitude(markerLocation.longitude);
                GpsData.setHomeLocation(homeLocation);
