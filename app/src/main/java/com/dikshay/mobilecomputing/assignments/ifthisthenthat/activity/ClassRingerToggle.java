...
public class ClassRingerToggle extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class_ringtone_toggle);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        toggleRecepie.setChecked(GpsData.isRingerVolumeToggle());

        // Add a marker to previous map location
        classLocation = GpsData.getClassLocation();
        if(classLocation != null){
            markerLocation = new LatLng(classLocation.getLatitude(), classLocation.getLongitude());
        }
        else{
        ...
        setLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Set Class Location
                classLocation = new Location("Home");
                classLocation.setLatitude(markerLocation.latitude);
                classLocation.setLongitude(markerLocation.longitude);
                GpsData.setClassLocation(classLocation);
        ...
        toggleRecepie.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    GpsData.setRingerVolumeToggle(true);
                    ...
                    GpsData.setRingerVolumeToggle(false);
                }
            }
        });
    }
